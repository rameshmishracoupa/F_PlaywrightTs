...
import { InsertActionLocators } from "../../locator/InsertActionLocators.ts";

export class InsertActionPage extends BasePage {
    waitUtils: WaitUtils;
    fillTableName: TextBox;
    configureButton: Button;
    saveConfiguration: Button;
    expressionBuilderExpandCollapse: Button;

    constructor(page: Page) {
        super(page);
        this.waitUtils = new WaitUtils(page);
        this.configureButton= new Button(InsertActionLocators.configureButton);
        this.saveConfiguration = new Button(InsertActionLocators.saveConfig);
        this.expressionBuilderExpandCollapse = new Button(InsertActionLocators.expressionBuilderExpandCollapse);
    }
